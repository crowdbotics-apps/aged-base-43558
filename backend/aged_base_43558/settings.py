"""
Django settings for aged_base_43558 project.
...
ROOT_URLCONF = 'aged_base_43558.urls'
...
WSGI_APPLICATION = 'aged_base_43558.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "aged_base_43558 API",
    "DESCRIPTION": "API documentation for aged_base_43558 App",
    "VERSION": "v1",
}
